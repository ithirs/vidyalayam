...
export const metadata: Metadata = {
  ...
  description: 'WhatsApp, SMS and push notifications for parents. Keep every parent informed with Adhira School ERP.',
};
...
export default function ParentCommunicationPage() {
  return (
    <ModulePage
      ...
      heroDesc="Eliminate missed circulars, unanswered questions and frustrated parents. Adhira sends automatic updates on attendance, fees, results and events and gives parents a direct line to the school."
      color="text-pink-600"
      bg="bg-pink-100"
      accentBg="bg-pink-50"
      features={[
      ...
      deepDive={[
        {
          ...
          desc: 'Parents in India are already on WhatsApp. Adhira sends attendance, fee receipts and report cards directly to parents\' WhatsApp — no new app to install.',
        },
        {
        ...
        },
        {
          ...
          desc: 'Parents who install the Adhira app can see attendance history, fee status, upcoming exams and report cards — all in their pocket.',
        },
      ]}
      relatedModules={[
